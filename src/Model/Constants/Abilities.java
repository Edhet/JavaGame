...
public enum Abilities {
    ...
    MALICIOUSATTACK("Ataque Malicioso", "Um ataque causado apenas por seres cruéis.", 2, 1),
    BADHEALING("Cicatrização Cruel", "Um miasma escuro capaz de curar monstros terríveis", 0, -1),
    SHOUT("Grito", "Thorffy utiliza de seus gritos para aterrorizar seus inimigos.", 3, 3),
    FEAR("Medo", "Zigg encontra os medos mais profundos de suas vítimas para fazê-las se renderem.", 4, 4),
    MANIPULATION("Manipulação", "Lorde Graf utiliza de manipulações para acabar com seus oponentes.", 5, 5);
