...
public enum ConsumableItems {
    ...
    SONG("Canto de Zeru", "Uma canção escrita por Zeru, famoso poeta da era da Grande Fome, capaz de aumentar, uma única vez, a sanidade do personagem.", 5, 1, 1),
    RING("Apogeu Anelar", "Um anel brilhante forjado de um material suspeito e não reconhecido capaz de aumentar a sanidade do personagem.", 5, 1, 1),
